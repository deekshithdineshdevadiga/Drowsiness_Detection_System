...
<body>
  ...
  border-radius: 10px;
                        ...
                        if (isset($_GET['eid'])) {
                            ...
                            $sdname = $rowsd['fname'];
                            $search = "SELECT * FROM `detected_log_cross`  WHERE `eid`='$ird' and gdate between '$fdate' and '$tdate' order by id desc";
                        } else {
                            $search = "SELECT * FROM `detected_log_cross`  WHERE gdate between '$fdate' AND '$tdate' order by id desc";
                        }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><button><a href='revert_log.php?id=<?php echo $id; ?>&fdate=<?php echo $fdate ?>&tdate=<?php echo $tdate ?>'>Revert</a></button></td>
                                        </tr>
