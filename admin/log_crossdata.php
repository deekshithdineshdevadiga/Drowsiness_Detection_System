...
<?php
    ...
    if (isset($_GET['eid'])) 
    {
        ...
        $sdname=$rowsd['fname'];
        $search = "SELECT DISTINCT * FROM `detected_log_cross`  WHERE `eid`='$ird' and gdate between '$fdate' and '$tdate' order by id desc";
       
    }else
    {
        $search = "SELECT DISTINCT * FROM `detected_log_cross`  WHERE gdate between '$fdate' AND '$tdate' order by id desc" ;
    }
