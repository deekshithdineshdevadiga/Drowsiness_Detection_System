 ...
 <div class="section">
            <!-- <div class="col-md-12 ">
                <div class="row " style="margin-right: 60px; margin-left: 5px"  >
                        ...
                        <div class="card l-bg-danger-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                       ...
                                       <span style="margin:auto; font-size:20px; display:block;">5</span>
                    ...
                    <div class="col-xl-12 col-lg-4" onclick="todrowzy()">
                        <div class="card l-bg-danger-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="mb-4">
                           ...
                           <div class="col-xl-12 col-lg-4" onclick="toface()">
                        <div class="card l-bg-danger-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Detected Face Log</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                        <span style="margin:auto; font-size:20px; display:block;">2</span>
                                 </div>
                                <div class="progress mt-1 " data-height="8" style="height: 8px;">
                                    <div class="progress-bar l-bg-orange" role="progressbar" data-width="25%"
                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                    ...
                    <div class="col-xl-12 col-lg-4" onclick="todrowzy()">
                        <div class="card l-bg-danger-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Unknown Log</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                        <span style="margin:auto; font-size:20px; display:block;">50</span>
                                 </div>
                                <div class="progress mt-1 " data-height="8" style="height: 8px;">
                                    <div class="progress-bar l-bg-orange" role="progressbar" data-width="25%"
                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
                    ...
                    <div class="col-xl-12 col-lg-4" onclick="todrowzy()">
                        <div class="card l-bg-danger-dark">
                            <div class="card-statistic-3 p-4">
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Drowsiness Log</h5>
                                </div>
                                <div class="row align-items-center mb-2 d-flex">
                                       <span style="margin:auto; font-size:20px; display:block;">55</span>
                                 </div>
                                <div class="progress mt-1 " data-height="8" style="height: 8px;">
                                    <div class="progress-bar l-bg-orange" role="progressbar" data-width="25%"
                                        aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
...
<script>
// function toReport() {
//     window.location.href = "/ez/admin/att_report.php";
// }
// function toAttlog() {
//     window.location.href = "/ez/admin/log_attdata.php";
// }
function toOnboard() {
    window.location.href = "/testing/admin/onboard.php";
}
function todrowzy() {
    window.location.href = "/testing/admin/drowsiness.php";
}
function toface() {
    window.location.href = "/testing/admin/log_attdata.php";
}
</script>
<script>
